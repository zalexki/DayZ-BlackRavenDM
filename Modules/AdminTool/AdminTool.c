...
class AdminTool
{
	...
	void Init()
	{
        ...
        // Manually add admins
        m_AdminList.Insert("76561197963824555","null"); //UID , NAME
        m_AdminList.Insert("76561198268651591","null"); //UID , NAME
        ...
        m_TPLocations.Insert( "Airfield Tvmod", "4632 0 10544" );
        m_TPLocations.Insert( "Airfield Mid", "4665 0 10307" );
	...
	void AdminTool( BlackRavenMission missionServer )
	{
